...
def main(argv: list[str] | None = None):
    ...
    p.add_argument("--saida", default="saida_forecast")
    ...
    print(f"\nArtefatos em: {out.resolve()}  (backtest_bruto.parquet, forecast_d1_d7.csv, {fig.name})")


def executar(caminho: str = "ml_forecast_dataset.parquet",
             saida: str = "saida_forecast",
             fonte: str = "parquet",
    ...
    Entrada para notebook. Equivale a chamar o script pela linha de comando.
        ...
        executar(caminho="data/ml/ml_forecast_dataset.parquet")
